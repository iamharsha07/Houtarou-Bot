...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
      ...
      if(player && channel.id !== player.voiceChannel)
        return message.channel.send(`**:x: You need to be in the same voice channel as bot to use this command**`);
      ...
      if(message.content.includes("youtu")){
        //send searching
        message.channel.send(`<a:music:861573021458235392> **Searching** :mag_right: \`${args.join(" ")}\``)
