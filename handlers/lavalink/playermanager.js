...
const search = args.join(" ");
  ...
  if(message.guild.me.permissionsIn(message.channel).has("EMBED_LINKS")){
    ...
    .setAuthor(message.author.username, message.author.displayAvatarURL({dynamic: true}), "https://github.com/iamharsha07")
    .setColor(ee.color)
    ...
    function playlist_() {
      ...
      var time = 0;
        let playlistembed = new Discord.MessageEmbed()
          ...
          .setAuthor(`Playlist added to Queue`, message.author.displayAvatarURL({dynamic:true}), "https://github.com/iamharsha07" )
          .setColor(ee.color)
